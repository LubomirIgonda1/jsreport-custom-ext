...
async function append2 (reporter, originalReq, spec) {
  const sourcePdfBuf = spec.data.sourcePdf
  const extraPdfBuf = spec.data.extraPdf
  // const manipulator = PdfManipulator(sourcePdfBuf)

  // await manipulator.append2(extraPdfBuf)

  // const resultPdfBuf = await manipulator.toBuffer()
  console.log(spec.data, originalReq, 'TEST222')
...
module.exports = (reporter) => ({
  ...
  'pdfUtils.append2': (...args) => append2(reporter, ...args),
